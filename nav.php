...
<?php 
	...
	echo '              		<a class="dropdown-item" href="results_list.php">Lista</a>';
	echo '              		<a class="dropdown-item" href="results_table.php">Tabela</a>';	
	echo '              		<a class="dropdown-item" href="results_chart_badanie.php">Badanie</a>';
	echo '              		<a class="dropdown-item" href="results_chart_porownanie.php">Porównanie</a>';
	echo '					</div>';
	echo '				  </li>';
	echo '				</div>';
//	echo '				</ul>';
