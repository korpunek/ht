...
<div class="container bg-light">
	...
	<div class="row bg-light">
        ...
        <?php
			...
			if($ile == 1){echo "<center><br><div>Brak danych do wyświetlenia.</div>";}else{echo "<center><br><div>Pozycji: " . ($ile-1) . "</div><br>";}
			echo "<br>";
		?>
